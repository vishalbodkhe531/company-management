...
const AuthPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-red-400">
      {/* Particle Background */}
      ...
      <motion.div
        ...
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 0.8 }}
        className="flex flex-col lg:flex-row items-center lg:items-stretch w-full max-w-7xl bg-green-400 p-4 md:p-8 gap-6 rounded-lg"
      >
        {/* Left Section */}
        <motion.div
        ...
        {/* Right Section */}
        <div className="flex flex-col items-center justify-center w-full lg:w-[57%] gap-6">
          {/* Tabs Form */}
          <Tabs
            defaultValue="account"
